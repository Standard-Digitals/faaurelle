...
export const heroResponsivePresets: Record<HeroResponsivePresetName, HeroResponsivePreset> = {
  ...
  tablet: {
    openingCamera: {
      ...
      position: [0.98, 0.76, 5.72],
      target: [0.98, 0.25, 0],
      fov: 38,
    },
    introCamera: {
      label: "Tablet opening front",
      position: [0.9, 0.79, 5.57],
      target: [0.9, 0.34, 0],
      fov: 38,
    },
    labelFramingCamera: {
    ...
    openingPosition: [1.04, -1.03, 0],
    openingRotation: [-0.18, 0.78, -0.46],
    openingScale: 0.79,
    settledScale: 0.79,
    chapterTwoScale: 0.7,
    bottleScale: 0.92,
  ...
  mobilePortrait: {
    openingCamera: {
      ...
      position: [0.58, 0.48, 4.95],
      target: [0.58, 0.02, 0],
      fov: 43,
    },
    introCamera: {
      label: "Mobile portrait opening front",
      position: [0.45, 0.56, 4.54],
      target: [0.45, 0.11, 0],
      fov: 42,
    },
    labelFramingCamera: {
    ...
    openingPosition: [0.7, -1.1, 0],
    openingRotation: [-0.1, 0.62, -0.27],
    openingScale: 0.52,
    settledScale: 0.52,
    chapterTwoScale: 0.5,
    bottleScale: 0.78,
  ...
  mobileLandscape: {
    openingCamera: {
      ...
      position: [0.82, 0.25, 5.05],
      target: [0.82, -0.12, 0],
      fov: 37,
    },
    introCamera: {
      label: "Mobile landscape opening front",
      position: [0.82, 0.31, 4.78],
      target: [0.82, -0.06, 0],
      fov: 36,
    },
    labelFramingCamera: {
    ...
    openingPosition: [0.92, -1.16, 0],
    openingRotation: [-0.07, 0.56, -0.18],
    openingScale: 0.5,
    settledScale: 0.5,
