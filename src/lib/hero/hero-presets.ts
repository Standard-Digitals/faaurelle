...
export const heroResponsivePresets: Record<HeroResponsivePresetName, HeroResponsivePreset> = {
  ...
  tablet: {
    ...
    chapterThreeEditorialEntryPosition: [5.8, -0.25, 0],
    chapterThreeEditorialPosition: [4.1, -0.25, 0],
    chapterThreeEditorialRotation: [0, 0.35, 1.5707963267948966],
  ...
  mobileLandscape: {
    ...
    chapterThreeEditorialEntryPosition: [5.7, -0.5, 0],
    chapterThreeEditorialPosition: [3.9, -0.5, 0],
    chapterThreeEditorialRotation: [0, 0.35, 1.5707963267948966],
    chapterThreeEditorialScale: 0.86,
